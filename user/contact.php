...
<body>
    ...
    <div class="text-gray-800 px-4 md:px-12">
        <h1 class="text-4xl font-bold italic flex justify-center items-center p-2">Contact Us</h1>
        <div class="block border-1 rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6 m-10">
            <div class="flex flex-wrap ">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-900">support@happymeal.com</p>
                        <p class="text-blue-600">+91 9845284820</p>
                        </div>
                    </div>
                    </div>
                    <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                    <div class="flex items-start">
                        ...
                        <p class="text-gray-900">sales@happymeal.com</p>
                        <p class="text-blue-600">+91 9732451207</p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="flex align-start">
                        ...
                        <p class="text-gray-900">press@happymeal.com</p>
                        <p class="text-blue-600">+91 8764928912</p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="flex align-start">
                        ...
                        <p class="text-gray-900">bugs@happymeal.com</p>
                        <p class="text-blue-600">+91 7845763956</p>
                        </div>
                    </div>
                    </div>
                </div>
