...
<body>
    ...
    <div class="w-full text-5xl font-bold italic flex justify-center">History</div>   
    <!-- order - history -->
    <div class="p-5 m-2">
        <div class="relative overflow-x-auto sm:rounded-lg m-2 border-[2px] w-full">
            <table class="w-full text-sm text-left text-black">
                <thead class="text-xl text-white uppercase bg-[#EB9901]">
                    <tr>
                ...
                <tbody class="text-md font-semibold">
                    <?php                             
                        ...
                        $sql = "SELECT o.OrderID AS ID, tp.Name AS PN, t.TiffinName AS TN, o.OrderDate AS SD, o.LastDate AS LD, o.TotalAmount AS TA
                        FROM Orders o
                        INNER JOIN Tiffins t ON o.TiffinID = t.TiffinID
                        INNER JOIN TiffinProviders tp ON t.ProviderID = tp.ProviderID
                        WHERE o.CustomerID = '{$user_data['CustomerID']}'";
